...
def create_authorisation_header(request_body=request_body_raw_text, created=None, expires=None):
    ...
    signing_key = create_signing_string(hash_message(request_body),created=created, expires=expires)
...
def verify_authorisation_header(auth_header='"Signature keyId="buyer-app.ondc.org|207|ed25519",algorithm="ed25519",created="1702468976",expires="1702472576",headers="(created) (expires) digest",signature="DjWLpWg5AFcExtc800dq/jAkhPSAm07u2qmDhaEccCNLqjmzC2QLmCfeSmbdFyQ8QWrnvrSQnQ4O3DYdztRfBQ==""', request_body_str=request_body_raw_text,
